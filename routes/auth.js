...
router.get('/facebook', isSecure, passport.authenticate('facebook', {scope : ['email']}));

router.get('/facebook/callback', isSecure, passport.authenticate('facebook'), function(req, res, next) {
